...
<nav className="navbar navbar-expand-md navbar-dark bg-dark sh-lg">
        <a className="navbar-brand" style={{marginLeft: 40}} href="#">Ceremony</a>
        <button
        ...
        <div className="collapse navbar-collapse" id="navbarNav">
          ...
          <ul className="navbar-nav ml-auto">
            ...
            <li className="nav-item">
              { status === "true" && <button style={{marginLeft: 1250}} onClick={exit} className="btn btn-danger">Logout</button>}
            </li>
          </ul>
        </div>
      </nav>
            ...
            <div className="card" style={{ marginTop: 5 }}>
              ...
              <div className="card-body">
                <div className="col-md-12">
                  ...
                  <iframe width="1250" height="700" src="https://www.youtube.com/embed/79u-y1RXROI" title="YouTube video player" frameBorder="0" allowFullScreen></iframe>
                </div>
                <div className="col-md-12">
